...
#         self.obj = {}
        ...
        self.lastclicG = None #dernier clic gauche
        self.lastclicD = None #dernier clic droit
        self.lastfinclic = None #denier clic relaché
...
# bindings
        ...
        self.bind("<ButtonRelease>", self.evenementFinClic)
...
#             print("Mouse", event)
            self.lastclicG = event

    def evenementClicD(self, event):
#         if event!=self.lastclic:
#             print("Mouse", event)
            self.lastclicD = event
            
    def evenementFinClic(self, event):
        self.lastfinclic = event
...
#         print(self.lastkey)
    ...
    def recupererFinClic(self):
        self.master.focus_force()
        self.update()
        finclic = self.lastfinclic
        self.lastfinclic = None
        return finclic
